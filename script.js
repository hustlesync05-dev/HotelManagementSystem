    ...
    if(db.active.role === 'admin') {
        ...
        area.innerHTML = `
            <div class="glass-card" style="max-width:550px; text-align:left; margin-bottom:20px">
                ...
                <p style="font-size:13px; margin:10px 0">📞 Phone: +1 800-AURELION</p>
                <p style="font-size:13px; margin:10px 0">📧 Email: support@aureliongrand.com</p>
            </div>
...
function openExp(id) {
    ...
    document.getElementById('modal-body').innerHTML = `
        ...
        <ul style="list-style:none; margin:15px 0">${e.points.map(p => `<li>✦ ${p}</li>`).join('')}</ul>
